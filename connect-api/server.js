...
const gfvRoutes = require('./routes/follows/venues');
const gfbRoutes = require('./routes/follows/buddies');
const gfuRoutes = require('./routes/follows/users');
...
app.use('/follows/users/:userId', gfuRoutes);
app.use('/follows/buddies/:userId', gfbRoutes);
app.use('/follows/venues/:venueId', gfvRoutes);
