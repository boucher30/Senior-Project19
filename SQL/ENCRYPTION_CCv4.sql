...
Values(uname, emailAddress,aes_encrypt(password),firstName,lastName,about,profileType,winterSports,waterSports,landSports,airSports);
END$$
...
BEGIN
select AES_DECRYPT from all_users where user_id = id ;
END$$
